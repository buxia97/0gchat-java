...
CREATE TABLE `chat_ban` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='黑名单表';
...
CREATE TABLE `chat_chat` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='聊天室列表';
...
INSERT INTO `chat_chat` VALUES (1,'闲聊群','这里主要提供闲聊灌水，没有话题指向，所以可以尽情聊天。','5',1,1694578764),(2,'征文聊天室','本届征文','1',1,1694576018);
...
CREATE TABLE `chat_msg` (
  ...
  `reply` int(11) DEFAULT '0' COMMENT '回复消息ID',
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COMMENT='消息列表';
...
INSERT INTO `chat_msg` VALUES (1,'伞兵一号卢本伟','127.0.0.1',0,'我觉得还可以吧，真的！','',1694513911,1,'15','zHf2e88bzP',0),(2,'伞兵一号卢本伟','127.0.0.1',0,'先断一下','',1694513928,1,'15','zHf2e88bzP',0),(3,'伞兵一号卢本伟','127.0.0.1',0,'你好','',1694513933,1,'15','zHf2e88bzP',0),(4,'伞兵一号卢本伟','127.0.0.1',0,'这是\n一个，换行的\n神奇效果','',1694514474,1,'15','zHf2e88bzP',0),(5,'伞兵一号卢本伟','127.0.0.1',0,'全体目光向我看齐','',1694515888,1,'15','zHf2e88bzP',0),(6,'伞兵一号卢本伟','127.0.0.1',0,'我宣布个事','',1694515896,1,'15','zHf2e88bzP',0),(7,'伞兵一号卢本伟','127.0.0.1',0,'可以吗？','',1694516550,1,'15','zHf2e88bzP',0),(8,'伞兵一号卢本伟','127.0.0.1',0,'天空的尽头啊','',1694516560,1,'15','zHf2e88bzP',0),(9,'伞兵一号卢本伟','127.0.0.1',0,'我觉得还行','',1694516802,1,'15','zHf2e88bzP',0),(10,'伞兵一号卢本伟','127.0.0.1',0,'是这样吧','',1694516808,1,'15','zHf2e88bzP',0),(11,'伞兵一号卢本伟','127.0.0.1',0,'是吗？','',1694519378,1,'15','zHf2e88bzP',0),(12,'渣渣灰','127.0.0.1',0,'我觉得还行啊','',1694520601,1,'69','B34VZwWMe7',0),(13,'渣渣灰','127.0.0.1',0,'没什么毛病','',1694520608,1,'69','B34VZwWMe7',0),(14,'渣渣灰','127.0.0.1',3,'百度一下，你就知道','https://www.baidu.com/',1694520947,1,'69','B34VZwWMe7',0),(15,'系统通知','127.0.0.1',2,'用户已被封禁','',1694523947,1,'3','zHf2e88bzP',0),(16,'系统消息','127.0.0.1',2,'发送系统通知','',1694529306,1,'',NULL,0),(19,'系统消息','127.0.0.1',2,'管理员封禁了IP[127.0.0.1]的聊天权限','',1694530395,1,'',NULL,0),(20,'渣渣灰','192.168.0.183',0,'这样可以吗？','',1694531200,1,'74','h3Y8sJzjtO',0),(21,'渣渣灰','192.168.0.183',0,'好嘛','',1694531207,2,'74','h3Y8sJzjtO',0),(22,'日内瓦退钱','192.168.0.183',0,'还行吧','',1694576018,2,'7','HyA6mc2QWU',0),(23,'系统消息','192.168.0.183',2,'管理员删除[渣渣灰]的一条消息','',1694577728,1,'',NULL,0),(24,'日内瓦退钱','192.168.0.183',0,'可以啊','',1694578454,1,'7','HyA6mc2QWU',20),(25,'伞兵一号卢本伟','192.168.0.126',0,'完全没问题吧，真的','',1694578752,1,'3','X73DSxt8Kv',24),(26,'伞兵一号卢本伟','192.168.0.126',0,'有没有搞错，哈哈','',1694578764,1,'3','X73DSxt8Kv',4);
