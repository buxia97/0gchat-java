...
public class ChatBanController {
    ...
    @ResponseBody
    public ApiResult insert (@RequestBody ChatBan chatBan, HttpServletRequest request) {
        int affectRows = service.insert(chatBan);
    ...
    @ResponseBody
    public ApiResult batchInsert (@RequestBody List<ChatBan> list, HttpServletRequest request) {
    ...
    @ResponseBody
    public ApiResult update (@RequestBody ChatBan chatBan, HttpServletRequest request) {
        int affectRows = service.update(chatBan);
        return new ApiResult<>(ResultCode.success.getCode(), affectRows, ResultCode.success.getDescr(), request.getRequestURI());
    }
    ...
    public ApiResult selectByKey (@RequestBody Object key, HttpServletRequest request) {
        ChatBan chatBan = service.selectByKey(key);
        return new ApiResult<>(ResultCode.success.getCode(), chatBan, ResultCode.success.getDescr(), request.getRequestURI());
    }
    ...
    */
    ...
    @ResponseBody
    public ApiResult selectList (@RequestBody ChatBan chatBan, HttpServletRequest request) {
        List<ChatBan> result = service.selectList(chatBan);
    ...
    public ApiResult selectPage (@RequestBody JSONObject object, HttpServletRequest request) {
        ...
        ChatBan chatBan = object.toJavaObject(ChatBan.class);
        PageList<ChatBan> pageList = service.selectPage(chatBan, page, pageSize);
    ...
    @ResponseBody
    public ChatBan formSelectByKey(@RequestParam(value = "key", required = false) String  key) {
    ...
    public String formInsert(@RequestParam(value = "params", required = false) String  params) {
        ...
        if (StringUtils.isNotBlank(params)) {
            ...
            insert = object.toJavaObject(ChatBan.class);
        }
    ...
    public String formUpdate(@RequestParam(value = "params", required = false) String  params) {
        ...
        if (StringUtils.isNotBlank(params)) {
            JSONObject object = JSON.parseObject(params);
            update = object.toJavaObject(ChatBan.class);
        }
